...
- `TELEGRAM_CHAT_IDS` — comma-separated numeric chat IDs (recommended). Current targets: `281486249` (`@y_tery`), `920099484` (`@TurkoOlga`).
- `TELEGRAM_USERNAMES` — optional fallback if `TELEGRAM_CHAT_IDS` is not set. Default: `@y_tery,@TurkoOlga`.
