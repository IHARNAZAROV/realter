...
--------------------------------------------------------------------------------------------- */
  ...
  function input_type_file_form () {
    ...
    jQuery('.btn-file :file').on('fileselect', function (event, numFiles, label) {
      ...
      const log = numFiles > 10 ? numFiles + ' files selected' : label
      if (input.length) {
        input.val(log)
      } else {
        if (log) alert(log)
  ...
  function home_projects_filter () {
    const owl = jQuery('.owl-carousel-filter').owlCarousel({
      loop: false,
      autoplay: false,
      margin: 30,
      nav: true,
    ...
    jQuery('.btn-filter-wrap').on('click', '.btn-filter', function (e) {
      const filter_data = jQuery(this).data('filter')
...
--------------------------------------------------------------------------------------------- */
  ...
  function masonryBox () {
    if (jQuery().isotope) {
      const $container = jQuery('.masonry-outer')
      $container.isotope({
